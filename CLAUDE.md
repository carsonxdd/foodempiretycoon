...
- **Named customer bubbles** in the day modal — 48 random first names, up to 4 bubbles per day, ratio skews to the day's mood. Total is capped at the day's actual `customers` count (0 walkups → no bubbles, 1 walkup → 1 bubble), trimming negatives first on good days and positives first on bad days so the surviving voices still match the mood.
